---
name: gco-file-conventions
description: Complete file location conventions for Ghost County artifacts. Invoke when you need the full directory structure, file size limits, or detailed location tables.
---

# File Location Conventions (Full Reference)
