...
This rule auto-enforces UI/UX design principles when Dev agents work in Frontend Mode.
...
This rule prevents those failures through mandatory checks and standards.
